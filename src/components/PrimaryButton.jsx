...
const PrimaryButton = ({ text, borderColor, textColor, arrowColor }) => {
  return (
    ...
    >
      <span
        className={`overflow-hidden max-w-0 opacity-0 group-hover:max-w-[200px] group-hover:opacity-100 transition-all duration-500 ease-in-out text-[15px] sm:text-base whitespace-nowrap ${textColor} group-hover:text-white`}
      >
        {text}
      </span>
      <HiArrowNarrowRight
