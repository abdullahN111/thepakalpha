...
const AboutUs = () => {
  ...
  return (
    <section className="max-width mx-auto" id="story">
      <div className="flex flex-col gap-10 py-12">
        <div className="bg-white">
          <div className="flex flex-col gap-2 items-center justify-center max-w-3xl mx-auto px-6">
            <h2 className="my-3 text-primary text-3xl sm:text-4xl uppercase montserrat-semibold text-center">
              Who Are We
            </h2>
          ...
          >
            <CarouselContent>
              {aboutUsData.map((item) => (
                ...
                >
                  <h2 className="color-black text-xl xs:text-[22px] sm:text-[26px] montserrat-semibold text-center px-6 mb-4">
                    {item.title}
                  </h2>
        ...
        <PrimaryButton text="See More" borderColor="border-black" />
      </div>
    </section>
  );
};
